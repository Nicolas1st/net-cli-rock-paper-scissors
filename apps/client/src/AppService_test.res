...
let defaultGameCode = Game.Code.fromString("1234")->OptionX.getExnWithMessage("Invalid game code.")
let defaultNickname = Nickname.fromString("Dmitry")->OptionX.getExnWithMessage("Invalid nickname.")
